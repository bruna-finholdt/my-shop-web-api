namespace Iteris.Loja.API.Services.Base
{
...
//Dentro dele, retornamos o conteúdo paginado e também a quantidade de páginas disponíveis, que é o
//arredondamento pra cima do número de itens totais no banco, divido pela quantidade por página.
